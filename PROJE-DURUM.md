...
### Paket 1 — İlk iş (riski düşük eklemeler):
- netlify.toml'daki /css/* ve /js/* immutable önbellek başlıklarını kaldır (yenileme öncesi ŞART, yoksa eski ziyaretçiler bozuk site görür)
- sitemap.xml + robots.txt oluştur
- canonical etiketi ekle (https://talevo.com.tr/)
- Open Graph + Twitter Card etiketleri (og:image için talevo-logo.png'den 1200x630 og-image.png üret)
- JSON-LD Organization şeması
...
- [ ] Site sahibi henüz ilk git add/commit/push pratiğini yapmadı — Paket 1 gönderiminde öğrenecek
